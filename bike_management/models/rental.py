...
class BikeRental(models.Model):
    ...
    def action_confirm(self):
        for rental in self:
            ...
            if (
                not rental.start_date
                or not rental.expected_return_date
            ):
                raise UserError(
                    _(
            ...
            repair = self.env['bike.repair'].search(
                [
            ...
            if repair:
                raise UserError(
                    _(
                        'This bike currently has an in-progress '
            ...
            if overlapping_rental:
                raise UserError(
                    _(
                        'This bike is already rented during the '
                        'selected dates.'
                    )
                )
